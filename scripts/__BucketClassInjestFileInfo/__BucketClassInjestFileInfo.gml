function __BucketClassInjestFileInfo(_injestStruct, _filePath) constructor
{
    __sourcePath = _filePath;
    
    __absolutePath = $"{BUCKET_PROJECT_DIRECTORY}{_injestStruct.__configStruct.__rootDirectory}{__sourcePath}";
