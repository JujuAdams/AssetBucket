...
function __BucketYYWriteSoundFile(_yypDirectory, _projectName, _sourcePath, _soundName, _folderInProject, _audioGroupName)
{
    var _directory = $"{_yypDirectory}sounds/{_soundName}/";
