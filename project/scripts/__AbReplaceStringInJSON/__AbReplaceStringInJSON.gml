function __AbReplaceStringInJSON(_yyString, _searchString, _newString)
{
    ...
    var _startPos = string_pos_ext("\"", _yyString, _pos + _searchLength);
    var _endPos = string_pos_ext("\n", _yyString, _startPos);
    _endPos = string_last_pos_ext("\"", _yyString, _endPos);
